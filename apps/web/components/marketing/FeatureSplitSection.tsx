        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/60 p-6 sm:p-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-base leading-relaxed text-slate-600">
                Audited & Open Source, our smart contracts ensure you always keep control of your money. Zero hidden fees.
              </motion.p>
            </motion.div>
